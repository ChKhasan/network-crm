<template lang="html">
  <div class="create pt-[120px] pb-[120px] max-w-[818px] mx-auto">
    <div class="flex justify-between">
      <h4 class="text-[24px] decor-500 text-black">Uyushmani o'zgartirish</h4>
...
export default {
  ...
  methods: {
    ...
    async __PUT_COMMUNITIES(form) {
      try {
        ...
        this.$notification["success"]({
          message: "Succes",
          description: `Uyushma muvaffaqiyatli o'zgartirildi`,
        });
    ...
    async deleteFiles(url) {
      try {
        const data = await communitiesApi.deleteFiles({ file: url });
      } catch (e) {
        this.$notification["error"]({
          message: "Error",
          description: e.response.statusText,
