  ...
  <div class="home-page pt-10 pb-[160px]">
    <div class="max-w-[818px] mx-auto px-4">
      <div class="mb-3 flex justify-between items-center">
        <h4 class="text-[24px] text-black decor-500 sm:text-[20px]">Tadbirlar</h4>
        <button
            @click="$router.push('/add')"
            class="sm:flex gap-2 h-10 rounded-lg bg-[#3C4BDC] items-center justify-center text-white px-3 text-[14px] font-semibold hidden"
          >
            Tadbir qoshish<svg
              width="24"
              height="24"
