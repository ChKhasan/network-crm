  ...
  <div class="home-page pt-10 pb-[160px]">
    <div class="max-w-[818px] mx-auto px-4">
      <div class="mb-3 flex justify-between items-center">
        <h4 class="text-[24px] text-black decor-500 sm:text-[20px]">Uyushmalar</h4>  <button
            @click="$router.push('/associations/add')"
            class="hidden gap-2 h-10 rounded-lg bg-[#3C4BDC] items-center justify-center text-white px-3 text-[14px] font-semibold sm:flex"
          >
            Uyushma qoshish<svg
              width="24"
              height="24"
      ...
      <div class="search">
        ...
        <div>
          <button
            @click="$router.push('/associations/add')"
            class="flex gap-2 h-12 rounded-xl bg-[#3C4BDC] items-center justify-center text-white px-5 text-[14px] font-semibold sm:hidden"
          >
            Uyushma qoshish<svg
              width="24"
              height="24"
