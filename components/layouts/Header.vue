      ...
      <div class="flex gap-4 tab sm:gap-2 sm:overflow-x-scroll tab-list">
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle cx="6" cy="4" r="2" stroke="#5C46E6" stroke-width="1.5" />
            <ellipse cx="6" cy="8" rx="3" ry="2" stroke="#5C46E6" stroke-width="1.5" />
            <circle cx="18" cy="16" r="2" stroke="#5C46E6" stroke-width="1.5" />
            <path
              ...
              stroke-linecap="round"
            />
            <ellipse cx="18" cy="20" rx="3" ry="2" stroke="#5C46E6" stroke-width="1.5" />
          </svg>
